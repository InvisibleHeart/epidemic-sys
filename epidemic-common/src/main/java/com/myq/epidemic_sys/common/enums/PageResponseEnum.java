...
public enum PageResponseEnum implements BaseResponseEnum {
    PAGE_SUC("200", "操作成功"),
    PAGE_ERR("300", "操作失败");
    ...
    PageResponseEnum(String code, String message) {
    ...
    public  String getDescriptionByCode(Integer code) {
        PageResponseEnum[] values = PageResponseEnum.values();
        for (PageResponseEnum value : values) {
